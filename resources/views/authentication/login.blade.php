...
<html lang="en">
	<head>
		...
		<!-- text fonts -->
		<link rel="stylesheet" href="/libs/assets/fonts/fonts.googleapis.com.css" />
		...
		<!--[if lt IE 9]>
		<script src="/libs/assets/js/html5shiv.min.js"></script>
 ...
 -->
		...
		<!--[if !IE]> -->
		<script src="/libs/assets/js/jquery.2.1.1.min.js"></script>

		<!-- <![endif]-->

		<!--[if IE]>
<script src="/libs/assets/js/jquery.1.11.1.min.js"></script>
<![endif]-->
