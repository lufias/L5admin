            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="form-group {{ $errors->has('resource') ? 'has-error' : '' }}">                            
                        ...
                        <div class="col-sm-9">                                
                            {{ Form::text('resource', '', ['id'=>'resource', 'class'=>'col-xs-10 col-sm-5', 'placeholder'=>'eg: PostModel (or anything; Forum, UserModel, etc)']) }} 
                    ...
                    <div class="form-group {{ $errors->has('label') ? 'has-error' : '' }}">                            
                        ...
                        <div class="col-sm-9">                                
                            {{ Form::text('label', '', ['id'=>'label', 'class'=>'col-xs-10 col-sm-5', 'placeholder'=>'Label (eg: Post)']) }}
                            @if($errors->has('label'))                               
                            <span class="help-block col-xs-12 col-sm-7">
                    ...
                    <div class="form-group {{ $errors->has('actions') ? 'has-error' : '' }}">
                        <div class="control-group">
                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label>                                        
                                        {{ Form::checkbox('actions[]', 'create', '', ["class"=>"ace ace-checkbox-2"]) }}
                                ...
                                <div class="checkbox">
                                    <label>
                                        {{ Form::checkbox('actions[]', 'read', '', ["class"=>"ace ace-checkbox-2"]) }}
                                ...
                                <div class="checkbox">
                                    <label>
                                        {{ Form::checkbox('actions[]', 'update', '', ["class"=>"ace ace-checkbox-2"]) }}
                                ...
                                <div class="checkbox">
                                    <label>
                                        {{ Form::checkbox('actions[]', 'delete', '', ["class"=>"ace ace-checkbox-2"]) }}
